        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    @if(Auth::user()->id == 1)
                        <img class="rounded-circle header-profile-user" 
                            style="object-fit: cover; object-position: center top 10%;" 
                            src="{{ $profileImageUrl }}"
                            alt="Header Avatar">
                    @else
                        <img class="rounded-circle header-profile-user" 
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('pegawai.change.password') }}"><i class="ri-wallet-2-line align-middle me-1"></i> Change Password</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        notificationDropdown.addEventListener('click', function () {
            fetch(notificationConfig.dataset.markAllReadUrl, { method: 'POST', headers: { 'X-CSRF-TOKEN': notificationConfig.dataset.csrfToken } });
        });
    });
</script>
