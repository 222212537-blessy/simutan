...
<head>
    <title>Ajukan Permintaan | SIMUTAN</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
</head>

<style>
    /* CSS UTAMA STEP INDICATOR */
    .step-indicator {
        display: flex;
        width: 100%;
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="textarea" class="form-control" maxlength="225" rows="3" placeholder="Jelaskan keperluan permintaan Anda di sini..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <form id="mainForm" method="post" action="{{ route('pilihan.store') }}">
                                                    ...
                                                    <div class="d-grid gap-2">
                                                        <button type="submit" class="btn btn-success waves-effect waves-light btn-lg" id="submit_btn" disabled>
                                                            <i class="mdi mdi-check-all me-1"></i> Ajukan Permintaan
                                                        </button>
...
$(document).ready(function() {
    ...
    // ====================================================================
    // A. FUNGSI RENDER KATALOG UTAMA (MENAMPILKAN GAMBAR, NAMA, STOK & BUTTON)
    // ====================================================================
    function renderCatalog(items) {
        ...
        items.forEach(item => {
            ...
            // Penanganan URL gambar fall-back jika file tidak ditemukan di public directory
            const foto = item.foto_barang 
                ? '/' + item.foto_barang 
                : '/backend/assets/images/barang/default_atk.png';
    ...
    // ====================================================================
    // B. LOGIKA PENYARING COMBINED FILTER (KELOMPOK, KATEGORI, KEYWORD)
    // ====================================================================
    ...
    // ====================================================================
    // C. AJAX LOAD DATA MASTER DARI BACKEND
    // ====================================================================
    function loadAllBarangs() {
        $('#catalog-list').html('<div class="col-12 text-center my-4 text-info fw-bold"><i class="mdi mdi-spin mdi-loading me-1"></i> Memuat data gudang SIMUTAN...</div>');
    ...
    // ====================================================================
    // D. MANAJEMEN SIDEBAR KERANJANG PERMINTAAN
    // ====================================================================
    ...
    $(document).on('click', '.add-to-cart-btn', function() {
        ...
        // Cek jika barang sudah ada di keranjang untuk update quantity
        ...
        if (existingItem) {
            ...
            cart.push({
                ...
                kelompok_id: product.kelompok_id,
                qty_req: qtyReq,
    ...
    // ====================================================================
    // E. WIZARD STEP NAVIGATION ENGINE
    // ====================================================================
